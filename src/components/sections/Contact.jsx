...
export const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    emailjs.sendForm(import.meta.env.VITE_SERVICE_ID, import.meta.env.VITE_TEMPLATE_ID, e.target, import.meta.env.VITE_PUBLIC_API).then((res) => {
      alert("Message sent");
    ...
    <section id="contact" className="min-h-screen min-w-screen flex items-center justify-center  py-20">
      <RevealOnScroll>
        <div className="px-4 md:w-150 w-100">
          <h2 className="text-5xl font-bold mb-8 bg-gradient-to-r from-blue-500 to-cyan-500 bg-clip-text text-transparent text-center">Get In Touch</h2>
